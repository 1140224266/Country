...
/*public class FarmerRenderer extends LivingEntityRenderer<AbstractClientPlayerEntity, PlayerEntityModel<AbstractClientPlayerEntity>> {
    ...
    public FarmerRenderer(EntityRendererFactory.Context ctx, boolean slim) {
...
public class FarmerRenderer extends MobEntityRenderer<Farmer, FarmerModel<Farmer>> {

    public static final Identifier TEXTURE = Identifier.of(Country.MOD_ID,"texture/entity/farmer.png");

    public FarmerRenderer(EntityRendererFactory.Context context) {
        super(context, new FarmerModel<>(context.getPart(ModModelLayers.FARMER),false),0.5f);
    }

    @Override
    public Identifier getTexture(Farmer entity) {
        return DefaultSkinHelper.getTexture(UUID.fromString("ed91ea5b-2470-419e-850c-4528175a58c8"));
    }

    @Override
    public void render(Farmer mobEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
