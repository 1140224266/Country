...
public class TestRenderer extends MobEntityRenderer<TEST, TestModel<TEST>> {
    ...
    public TestRenderer(EntityRendererFactory.Context context) {
        super(context, new TestModel<>(context.getPart(ModModelLayers.FARMER),false),0.5f);
    ...
    @Override
    public Identifier getTexture(TEST entity) {
        return DefaultSkinHelper.getTexture(UUID.fromString("ed91ea5b-2470-419e-850c-4528175a58c8"));
    }

    @Override
    public void render(TEST mobEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
